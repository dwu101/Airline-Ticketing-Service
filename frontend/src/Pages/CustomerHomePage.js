    ...
    <div>
        ...
        {displayAddPhone && (
          ...
          {displayFlights && (
            <div>
              <h1> Flights: </h1>
              <DisplaySQL mapToDisplay={flights} clickable={true} setState={setCancelClicked} state={cancelClicked} />
          ...
          {displayReview && (
            <div>
              ...
              <DisplaySQL mapToDisplay={pastFlights} clickable={true} setState={setReviewClicked} state={reviewClicked} />
